...
public class SorumPdfExport {
    public void export(List<Sorum> hewanList) throws IOException {
        ...
        Cell<PDPage> cell = headerRow.createCell(100, "Nota Pembelian Sorum");
        ...
        cell.setAlign(HorizontalAlignment.CENTER);
        cell.setFontSize(15);
        cell = row.createCell(10, "Alamat");
        cell.setAlign(HorizontalAlignment.CENTER);
        cell.setFontSize(15);
        cell = row.createCell(20, "Jenis motor");
        cell.setAlign(HorizontalAlignment.CENTER);
        cell.setFontSize(15);
        cell = row.createCell(20, "Merek");
        cell.setAlign(HorizontalAlignment.CENTER);
        cell.setFontSize(15);
        cell = row.createCell(20, "Motor");
        cell.setAlign(HorizontalAlignment.CENTER);
        cell.setFontSize(15);
